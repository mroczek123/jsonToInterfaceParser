...
export const considerStringType: TypeConverterFunctionInterface = function (input: Array<{ type: Type; value: any; }>, attributeName: string, converter: Converter): { valsWithTypesArray: Array<{ type: Type; value: any; }>, discoveredTypes: Array<Type> } {
  const output = {
...
export const considerObjectType: TypeConverterFunctionInterface = function (input: Array<{ type: Type; value: any; }>, attributeName: string, converter: Converter): { valsWithTypesArray: Array<{ type: Type; value: any; }>, discoveredTypes: Array<Type> } {
  const output = {
    valsWithTypesArray: input,
    discoveredTypes: []
  }
  ...
  const objectInterface = converter.convertToInterface(filtered.map(valWithType => valWithType.value), capitalizedAttributeName);
...
export const considerArrayType: TypeConverterFunctionInterface = function (input: Array<{ type: Type; value: any; }>, attributeName: string, converter: Converter): { valsWithTypesArray: Array<{ type: Type; value: any; }>, discoveredTypes: Array<Type> } {
  const output = {
    valsWithTypesArray: input,
    discoveredTypes: []
  };
...
export const considerOtherTypes = function (input: Array<{ type: Type; value: any; }>, attributeName: string, converter: Converter): { valsWithTypesArray: Array<{ type: Type; value: any; }>, discoveredTypes: Array<Type> } {
